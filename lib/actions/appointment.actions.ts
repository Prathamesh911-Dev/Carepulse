...
export const getRecentAppointmentList = async () => {
    ...
    //console.log('Scheduled Appointments Count:', counts.scheduledCount);
    ...
    UpdateAppointmentParams) => {
        try {
            ...
            ${type === 'schedule'
                ...
                : `We regret to inform you that your appointment has been cancelled for the following Reasone: ${appointment.cancellationReason}`
            }
